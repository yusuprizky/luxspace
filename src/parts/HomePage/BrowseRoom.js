...
export default function BrowseRoom() {
  const {data, status, error, run, isLoading} = useAsync({data: {}});
  useEffect(() => {
    run (
  ...
  const ratioClassNames = {
    ...
    meta:{
        ...
        "2/2": "inset-0 md:bottorm-auto flex md:justify-start justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12",
        "2/3": "inset-0 md:bottorm-auto flex md:justify-start justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12"
